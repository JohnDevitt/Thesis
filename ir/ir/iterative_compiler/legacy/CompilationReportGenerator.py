...
def main(baseline_runtime, best_configuration, best_runtime, directory):
	...
	filepath = os.path.join(directory, "compilation_report.txt")
	...
	report = {'Best': best_runtime, 'Baseline': baseline_runtime, 'Difference': difference, 'Proportion': proportion, 'Configuration': best_configuration}

	with open(os.path.join(directory, "compilation_report.pickle"), 'wb') as f:
