...
main(int argc, char* argv[]) try {
  ...
  // Initialize prefixes.
  prefix = "/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install";
  exec_prefix = "${prefix}";
  ...
  if (required_cppflags) {
    if (required_application) {
      std::string cppflags = "-I/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/include";
	...
	if (cppflags.find(s) != std::string::npos)
	  s = "";
	if (s.length() > 0 && strlen("-I/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/include") > 0)
	  s += ' ';
	s += "-I/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/include";
      }
      ...
      portray("CPPFLAGS", "-I/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/include");
  }

  if (required_cflags)
    portray("CFLAGS", " -g -O2 -frounding-math -I/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/include -fpermissive -W -Wall");

  if (required_cxxflags)
    portray("CXXFLAGS", " -g -O2 -frounding-math -I/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/include -fpermissive -W -Wall");

  if (required_ldflags) {
    std::string s = "${exec_prefix}/lib";
    replace_prefixes(s);
    const std::string ldflags = "-L/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/lib";
    ...
    if (required_library) {
      if (s.length() > 0 && strlen(" -lm -L/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/lib -lgmpxx -L/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/lib -lgmp -R/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/lib -R/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/lib") > 0)
	s += ' ';
      s += " -lm -L/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/lib -lgmpxx -L/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/lib -lgmp -R/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/lib -R/home/john/thesis/milepost/ctuning-cc-2.5-gcc-4.4.4-ici-2.05-milepost-2.1/install/lib";
    }
    else {
