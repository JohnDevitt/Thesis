...
################################################################################
echo "*************** CCC: Compile all additional tools ***************"

upd=0
echo ""
echo "Would you like to try to compile additional tools (Y/N)?"
echo "  (some of them may require third-party software (such as PAPI library)"
...
recursive $CUR/src-plat-dep/tools-aux
