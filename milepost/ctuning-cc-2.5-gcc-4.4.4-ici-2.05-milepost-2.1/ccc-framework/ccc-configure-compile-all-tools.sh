...
recursive $CUR/src-plat-dep/tools

#Moved timed-run into $CCC_TIMED_RUN - user can select it or not ...
##Check timed-run
#echo "============================================================="
#echo ""
#echo "Checking \"timed-run\" program ..."
#timed-run 2> $FILE_CCC_TMP
#
#i=0
#exec 9< $FILE_CCC_TMP
#while <&9 read line ;
...
#if [ $i -lt "2" ] ; then
# echo ""
# echo "\"timed-run\" program to limit execution time is not installed..."
# echo "Would you like to use a dummy timed-run (Y/N)?"
#
# read var1
#   
# if [ "$var1" = "Y" ] || [ "$var1" = "y" ] ; then
#  cp -rf $GLB_CFG/_default/timed-run $GLB_DEST/bin
# fi
#fi
