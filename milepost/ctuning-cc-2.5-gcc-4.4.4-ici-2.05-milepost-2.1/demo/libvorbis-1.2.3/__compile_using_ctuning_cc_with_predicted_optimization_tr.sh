...
#Trigger transparent program optimization prediction and aggregate info about compiled program
export CTUNING_PREDICT_OPTIMIZATIONS=$PWD/_ctuning_program_structure.txt
...
rm -f $CTUNING_PREDICT_OPTIMIZATIONS
